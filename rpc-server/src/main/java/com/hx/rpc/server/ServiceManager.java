...
public class ServiceManager {
    ...
    public void ZKRegistry(ServiceDescriptor sdp){
        try {
            ...
            zookeeper.createEphemeraNode(registryPath + "/" + sdp.getClazz() + "/" + sdp.hashCode()+"/127.0.0.1:3000", "");
            if(zookeeper.exist(registryPath + "/" + sdp.getClazz() + "/" + sdp.hashCode()+"/127.0.0.1:3000")){
                log.info("zookeeper注册成功 {} ",registryPath + "/" + sdp.getClazz() + "/" + sdp.hashCode()+"/127.0.0.1:3000");
            }
